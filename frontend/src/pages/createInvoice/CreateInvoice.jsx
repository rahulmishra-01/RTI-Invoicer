...
const CreateInvoice = () => {
  ...
  useEffect(() => {
    const InvoiceNumber = async () => {
      try {
        const res = await axios.get(
          `${import.meta.env.VITE_API_BASE_URL}/api/invoices/new-invoice-number`
        );
        setForm((prevForm) => ({
          ...prevForm,
            ...
            <div className={styles.billToSection}>
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("buyerDetails", "addressLine1", e.target.value)
                  }
                  required
                />
              </div>
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("buyerDetails", "addressLine2", e.target.value)
                  }
                />
              </div>
              <div
            ...
            {isMobile && editProductModal && (
              <div className={styles.productModal}>
                <div className={styles.productModalForm}>
                  ...
                  <button type="button" onClick={handleEditProductModalSubmit}>
                    Update
                  </button>
                  <button
                    type="button"
